...
export const loader = async () => {
	...
	const supplierDetails = await db.supplier.findMany({
	...
	const _suppliers = suppliers.map(supplier => {
		return {
			...supplier,
			companyName: supplierDetails.find(
				supplierDetail => supplierDetail.id === supplier.id
			)?.companyName,
		}
	})

	return json({suppliers: _suppliers})
}
...
const images = [
	...
	'https://images.unsplash.com/photo-1485348616965-15c926318fbb?q=80&w=2875&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
	'https://images.unsplash.com/photo-1604066867775-43f48e3957d8?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
]
export const action: ActionFunction = async ({request}) => {
	...
	await db.supplier.create({
		data: {
			...
			phoneNo: fields.phoneNo,
			image:
				images[Math.floor(Math.random() * (images.length - 1 - 0 + 1)) + 0],
...
export default function ManageSuppliers() {
	...
	return (
		<>
			<TailwindContainer className="!max-w-full rounded-md bg-white">
